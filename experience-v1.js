...
const state={index:null,topic:null,current:null,visited:new Set(JSON.parse(localStorage.getItem('chronos-explore-visited')||'[]')),missionDone:new Set(JSON.parse(localStorage.getItem('chronos-mission-done')||'[]'))};
const lang=()=>document.documentElement.dataset.lang==='ru'?'ru':'ja';
const t=v=>v?.[lang()]??v?.ja??v??'';
const esc=s=>String(s??'').replace(/[&<>\"]/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','\"':'&quot;'}[c]||c));
const copy={
 ja:{
  explore:'EXPLORE', exploreTitle:'好奇心のまま、歴史へ潜る', exploreCopy:'ひとつのテーマから、暮らし・技術・信仰・交易・政治へ。気になった方向へ自由に進めます。',
  featured:'FEATURED WORLD', mission:'MISSION', missionTitle:'まだ知らない歴史を、自分で調べる', missionCopy:'CHRONOSが問いを出します。記事を探し、証拠を集め、最後に自分の言葉で答えます。',
  startHere:'START HERE', startHereTitle:'今日はここから始める', startExplore:'ヴァイキング時代を探索する', startMission:'未知のMISSIONに挑戦する', myMap:'自分の世界史を見る',
  topicSub:'海を越えた人々', pages:'12の入口', learned:'探索済み', open:'読む', backTopic:'ヴァイキング時代へ戻る', question:'QUESTION', answer:'結論からいうと', evidence:'なぜそう言える？', soWhat:'だから何が重要？', next:'次の問い',
  missionKicker:'MISSION 01 · DISCOVER', missionQ:'なぜ北欧の人々は海へ出て、広い世界とつながったのか？', missionIntro:'3つの手がかりをCHRONOSの中から集めてください。答えは先に表示しません。', clue:'手がかり', done:'調査済み', investigate:'調べる', final:'FINAL TEST', locked:'3つの手がかりを調べると解放されます', finalQ:'ヴァイキング時代に北欧の人々が海へ出た理由を、複数の要因をつないで説明してください。', placeholder:'自分の言葉で説明する', submit:'答えを確かめる',
  feedbackShort:'もう少し調べた内容をつないでみましょう。原因を2つ以上入れると、より歴史の動きが見えます。', feedbackGood:'いい説明です。ひとつの原因ではなく、環境・技術・交易など複数の条件をつないで考えられています。', unlocked:'FINAL TESTが解放されました', mapCopy:'読むだけでなく、説明できた範囲がここに残ります。',
  coming:'NEXT MISSION', comingTitle:'同じ西暦900年ごろ、世界の他の地域では何が起きていた？', comingCopy:'ヴァイキングの次は、同時代のイスラム世界・東アジアへ視野を広げます。'
 },
 ru:{
  explore:'EXPLORE', exploreTitle:'Погружайтесь в историю из любопытства', exploreCopy:'Начните с одной темы и уходите в быт, технологии, веру, торговлю и политику.',
  featured:'FEATURED WORLD', mission:'MISSION', missionTitle:'Исследуйте то, чего ещё не знаете', missionCopy:'CHRONOS задаёт вопрос. Вы ищете материалы, собираете доказательства и отвечаете своими словами.',
  startHere:'START HERE', startHereTitle:'Начните сегодня отсюда', startExplore:'Исследовать эпоху викингов', startMission:'Пройти новую миссию', myMap:'Моя карта истории',
  topicSub:'Люди, пересекавшие моря', pages:'12 входов', learned:'изучено', open:'Читать', backTopic:'Назад к эпохе викингов', question:'ВОПРОС', answer:'Короткий ответ', evidence:'Почему мы так считаем?', soWhat:'Почему это важно?', next:'Следующий вопрос',
  missionKicker:'MISSION 01 · DISCOVER', missionQ:'Почему жители Скандинавии вышли в море и связались с огромным миром?', missionIntro:'Найдите в CHRONOS три подсказки. Ответ заранее не показывается.', clue:'Подсказка', done:'Изучено', investigate:'Исследовать', final:'FINAL TEST', locked:'Откроется после трёх подсказок', finalQ:'Объясните несколькими связанными причинами, почему люди эпохи викингов выходили в море.', placeholder:'Ответьте своими словами', submit:'Проверить ответ',
  feedbackShort:'Свяжите ещё несколько найденных фактов. Попробуйте назвать хотя бы две причины.', feedbackGood:'Хорошо. Вы связываете несколько условий — среду, технологии, торговлю и общество — вместо одной причины.', unlocked:'FINAL TEST открыт', mapCopy:'Сохраняется не только прочитанное, но и то, что вы можете объяснить.',
  coming:'NEXT MISSION', comingTitle:'Что происходило в других регионах мира около 900 года?', comingCopy:'После викингов миссия расширит взгляд на исламский мир и Восточную Азию.'
 }
};
const C=()=>copy[lang()];
